                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown"><a class="nav-link menu-title" href="#"><i data-feather="home"></i><span>Dashboard</span></a>
                        <ul class="nav-submenu menu-content">
                            ...
                            <li><a href="dashboard-02.html">Helpdesk</a></li>
                            <li><a href="dashboard-03.html">Social</a></li>
                            <li><a href="dashboard-04.html">Enterprise</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown"><a class="nav-link menu-title" href="#"><i data-feather="folder-plus"></i><span>Bonus Ui</span><span class="badge badge-success">Hot</span></a>
                        <ul class="nav-submenu menu-content">
                    ...
                    <li class="dropdown"><a class="nav-link menu-title" href="#"><i data-feather="layout"></i><span>Page layout</span></a>
                        <ul class="nav-submenu menu-content">
                            ...
                            <li><a href="layout-light.html">Light Layout</a></li>
                    ...
                    <li class="dropdown"><a class="nav-link menu-title" href="#"><i data-feather="grid"> </i><span>Pages</span><span class="badge badge-danger">New</span></a>
                        <ul class="nav-submenu menu-content">
